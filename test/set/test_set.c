...
static void
test_set_init_destroy(set_type_t type)
{
    set_t set = NULL;
...
static void
test_bit_vector_set_init_destroy(void)
{
    test_set_init_destroy(BIT_VECTOR_SET);
}

static void
test_linked_list_set_init_destroy(void)
{
    test_set_init_destroy(LINKED_LIST_SET);
}

static void
test_set_insert_member_delete_clear(set_type_t type)
{
    set_t set;
...
static void
test_bit_vector_set_insert_member_delete_clear(void)
{
    test_set_insert_member_delete_clear(BIT_VECTOR_SET);
}

static void
test_linked_list_set_insert_member_delete_clear(void)
{
    test_set_insert_member_delete_clear(LINKED_LIST_SET);
}

static void
test_set_length_is_empty(set_type_t type)
{
    set_t set;
...
static void
test_bit_vector_set_length_is_empty(void)
{
    test_set_length_is_empty(BIT_VECTOR_SET);
}

static void
test_linked_list_set_length_is_empty(void)
{
    test_set_length_is_empty(LINKED_LIST_SET);
}

static void
test_set_union_intersection_difference(set_type_t type)
{
    set_t a, b, c;
    set_element_t e0 = 12, e1 = 79, e2 = 99;
...
static void
test_bit_vector_set_union_intersection_difference(void)
{
    test_set_union_intersection_difference(BIT_VECTOR_SET);
}

static void
test_linked_list_set_union_intersection_difference(void)
{
...
static CU_TestInfo set_tests[] = {
    ...
    {"bit vector set: insert, member, delete, clear",
     test_bit_vector_set_insert_member_delete_clear},
    {"bit vector set: length, is_empty", test_bit_vector_set_length_is_empty},
    {"bit vector set: union, intersection, difference",
     test_bit_vector_set_union_intersection_difference},

    {"linked list set: init, destroy", test_linked_list_set_init_destroy},
    {"linked list set: insert, member, delete, clear",
     test_linked_list_set_insert_member_delete_clear},
    {"linked list set: length, is_empty",
     test_linked_list_set_length_is_empty},
    {"linked list set: union, intersection, difference",
     test_linked_list_set_union_intersection_difference},
