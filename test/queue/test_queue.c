...
int
init_queue_suite(void)
{
    return 0;
}

int
cleanup_queue_suite(void)
{
    return 0;
}

static void
test_queue_init_destroy(queue_type_t type)
{
    queue_t queue = NULL;
...
static void
test_static_queue_init_destroy(void)
{
    test_queue_init_destroy(STATIC_QUEUE);
}

static void
test_dynamic_queue_init_destroy(void)
{
...
static void
test_queue_enqueue_dequeue_front_length(queue_type_t type)
{
    queue_t queue;
...
static void
test_static_queue_enqueue_dequeue_front_length(void)
{
    test_queue_enqueue_dequeue_front_length(STATIC_QUEUE);
}

static void
test_dynamic_queue_enqueue_dequeue_front_length(void)
{
...
static void
test_queue_is_empty_is_full(queue_type_t type)
{
    queue_t queue;
...
static void
test_static_queue_is_empty_is_full(void)
{
    test_queue_is_empty_is_full(STATIC_QUEUE);
}

static void
test_dynamic_queue_is_empty_is_full(void)
{
...
static void
test_queue_clear(queue_type_t type)
{
    queue_t queue;
    queue_element_t e0 = 0, e1 = 10;
...
static void
test_static_queue_clear(void)
{
    test_queue_clear(STATIC_QUEUE);
}

static void
test_dynamic_queue_clear(void)
{
...
static CU_TestInfo queue_tests[] = {
    ...
    {"static queue: enqueue, dequeue, front, length",
     test_static_queue_enqueue_dequeue_front_length},
    ...
    {"dynamic queue: enqueue, dequeue, front, length",
     test_dynamic_queue_enqueue_dequeue_front_length},
