...
int cleanup_list_suite(void) { return 0; }
...
static void test_linked_list_init_destroy(void) {
    test_list_init_destroy(LINKED_LIST);
}

static void test_doubly_linked_list_init_destroy(void) {
    test_list_init_destroy(DOUBLY_LINKED_LIST);
}


static void test_list_get_insert_remove(list_type_t type) {
    list_t list;
...
static void test_linked_list_get_insert_remove(void) {
    test_list_get_insert_remove(LINKED_LIST);
}

static void test_doubly_linked_list_get_insert_remove(void) {
    test_list_get_insert_remove(DOUBLY_LINKED_LIST);
}


static void test_list_first_last(list_type_t type) {
    list_t list;
...
static void test_linked_list_first_last(void) {
    test_list_first_last(LINKED_LIST);
}

static void test_doubly_linked_list_first_last(void) {
...
static void test_linked_list_is_empty_is_full(void) {
    test_list_is_empty_is_full(LINKED_LIST);
}
static void test_doubly_linked_list_is_empty_is_full(void) {
    test_list_is_empty_is_full(DOUBLY_LINKED_LIST);
}


static void test_list_clear(list_type_t type) {
    list_t list;
...
static void test_doubly_linked_list_clear(void) {
...
void test_list_locate(list_type_t type) {
    list_t list;
...
static void test_linked_list_locate(void) {
    test_list_locate(LINKED_LIST);
}
static void test_doubly_linked_list_locate(void) {
