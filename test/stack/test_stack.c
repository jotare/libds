...
int init_stack_suite(void) { return 0; }
int cleanup_stack_suite(void) { return 0; }


static void test_stack_init_destroy(stack_type_t type) {
    stack_t stack = NULL;
...
static void test_dynamic_stack_init_destroy(void) {
    test_stack_init_destroy(DYNAMIC_STACK);
}


static void test_stack_push_pop_top_length(stack_type_t type) {
    stack_t stack;
...
static void test_static_stack_push_pop_top_length(void) {
    test_stack_push_pop_top_length(STATIC_STACK);
}

static void test_dynamic_stack_push_pop_top_length(void) {
    test_stack_push_pop_top_length(DYNAMIC_STACK);
}


static void test_stack_is_empty_is_full(stack_type_t type) {
    stack_t stack;
...
static void test_static_stack_is_empty_is_full(void) {
    test_stack_is_empty_is_full(STATIC_STACK);
}

static void test_dynamic_stack_is_empty_is_full(void) {
    test_stack_is_empty_is_full(DYNAMIC_STACK);
}


static void test_stack_clear(stack_type_t type) {
    stack_t stack;
    stack_element_t e0 = 0, e1 = 10;
...
static void test_static_stack_clear(void) {
    test_stack_clear(STATIC_STACK);
}

static void test_dynamic_stack_clear(void) {
...
static CU_TestInfo stack_tests[] = {
    ...
    {"static stack: push, pop, top, length", test_static_stack_push_pop_top_length},
    ...
    {"dynamic stack: push, pop, top, length", test_dynamic_stack_push_pop_top_length},
