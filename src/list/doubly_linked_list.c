...
int doubly_linked_list_init(doubly_linked_list_t *dllist) {
...
inline unsigned int doubly_linked_list_length(const doubly_linked_list_t dllist) {
    return ((_doubly_linked_list_t *)dllist)->n;
}

inline bool doubly_linked_list_is_empty(const doubly_linked_list_t dllist) {
    return ((_doubly_linked_list_t *)dllist)->n == 0;
}

inline bool doubly_linked_list_is_full(const doubly_linked_list_t dllist) {
    return false;
}

doubly_linked_list_element_t doubly_linked_list_first(const doubly_linked_list_t dllist) {
    _doubly_linked_list_t *list;
...
doubly_linked_list_element_t doubly_linked_list_last(const doubly_linked_list_t dllist) {
    _doubly_linked_list_t *list;
...
doubly_linked_list_element_t doubly_linked_list_get(const doubly_linked_list_t dllist, unsigned int n) {
     _doubly_linked_list_t *list;
    node_t *node;
    int length;
...
int doubly_linked_list_insert(doubly_linked_list_t dllist, unsigned int n, doubly_linked_list_element_t elem) {
    _doubly_linked_list_t *list;
    node_t *new_node;
    int length;
...
int doubly_linked_list_append(doubly_linked_list_t dllist, doubly_linked_list_element_t elem) {
    if (doubly_linked_list_is_full(dllist))
	return -1;
    return doubly_linked_list_insert(dllist, doubly_linked_list_length(dllist), elem);
}

int doubly_linked_list_prepend(doubly_linked_list_t dllist, doubly_linked_list_element_t elem) {
    if (doubly_linked_list_is_empty(dllist))
	return -1;
    return doubly_linked_list_insert(dllist, 0, elem);
}

doubly_linked_list_element_t doubly_linked_list_remove(doubly_linked_list_t dllist, unsigned int n) {
    _doubly_linked_list_t *list;
    node_t *remove_node;
    int length;
...
int doubly_linked_list_locate(const doubly_linked_list_t dllist, doubly_linked_list_element_t elem,
