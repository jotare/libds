 ...
 */
int8_t doubly_linked_list_init(doubly_linked_list_t *dlist);
 ...
 * Insert
 */
int8_t doubly_linked_list_insert(doubly_linked_list_t dlist, uint8_t n, doubly_linked_list_element_t elem);
int8_t doubly_linked_list_append(doubly_linked_list_t dlist, doubly_linked_list_element_t elem);
int8_t doubly_linked_list_prepend(doubly_linked_list_t dlist, doubly_linked_list_element_t elem);

/**
 * Remove
 */
doubly_linked_list_element_t doubly_linked_list_remove(doubly_linked_list_t dlist, uint8_t n);
