 ...
 * Insert
 */
int doubly_linked_list_insert (doubly_linked_list_t dlist, unsigned int n,
                               doubly_linked_list_element_t elem);
int doubly_linked_list_append (doubly_linked_list_t dlist,
                               doubly_linked_list_element_t elem);
int doubly_linked_list_prepend (doubly_linked_list_t dlist,
                                doubly_linked_list_element_t elem);
