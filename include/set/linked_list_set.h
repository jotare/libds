 ...
 * @return positive integer or 0 if success, negative one if fails
*/
int linked_list_set_union(const linked_list_set_t a, const linked_list_set_t b, linked_list_set_t *c);
int linked_list_set_intersection(const linked_list_set_t a, const linked_list_set_t b, linked_list_set_t *c);
int linked_list_set_difference(const linked_list_set_t a, const linked_list_set_t b, linked_list_set_t *c);
